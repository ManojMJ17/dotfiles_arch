...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("hypridle -c " .. os.getenv("HOME") .. "/Projects/ricing/Brain_Shell/src/config/hypridle.conf")
    hl.exec_cmd("quickshell -c " .. os.getenv("HOME") .. "/Projects/ricing/Brain_Shell")
...
-- Brain_ShellKeybinds
dofile("/home/manoj/.config/Brain_Shell/Brain_ShellKeybinds.lua")
